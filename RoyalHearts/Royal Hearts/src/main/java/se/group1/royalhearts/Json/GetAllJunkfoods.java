 ...
 */
public class GetAllJunkfoods extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        try {
            JsonManager.junkfoods.clear();
            JsonManager.junkfoods.addAll(JsonManager.getJunkfoodsFromJson(result));
        } catch (Exception e) {}
    }
