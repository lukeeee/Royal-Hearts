 ...
 */
public class GetStoresByCity extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        try {
            JsonManager.stores.clear();
            JsonManager.stores.addAll(JsonManager.getStoresFromJson(result));
        } catch (Exception e) {}
    }
