 ...
 */
public class GetAllDairies extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        try {
            JsonManager.dairies.clear();
            JsonManager.dairies.addAll(JsonManager.getDairiesFromJson(result));
        } catch (Exception e) {}
    }
