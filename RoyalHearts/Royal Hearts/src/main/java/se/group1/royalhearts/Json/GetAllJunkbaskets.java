 ...
 */
public class GetAllJunkbaskets extends AsyncTask<String, Void, String> {
...
protected void onPostExecute(String result) {
        try {
        JsonManager.junkfoodbaskets.clear();
        JsonManager.junkfoodbaskets.addAll(JsonManager.getJunkfoodbasketsFromJson(result));
        } catch (Exception e) {}
        }
