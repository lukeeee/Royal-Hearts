 ...
 */
public class GetAllVegetables extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        try {
            JsonManager.vegetables.clear();
            JsonManager.vegetables.addAll(JsonManager.getVegetablesFromJson(result));
        } catch (Exception e) {}
    }
