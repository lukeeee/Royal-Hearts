 ...
 */
public class GetAllHealth extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        try {
            JsonManager.healths.clear();
            JsonManager.healths.addAll(JsonManager.getHealthsFromJson(result));
        } catch (Exception e) {}
    }
