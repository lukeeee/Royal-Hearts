 ...
 */
public class GetAllMeatbaskets extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        try {
            JsonManager.meatbaskets.clear();
            JsonManager.meatbaskets.addAll(JsonManager.getMeatbasketsFromJson(result));
        } catch (Exception e) {}
    }
